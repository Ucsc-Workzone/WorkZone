        ...
        >
            <ListItemWrapper>
                ...
                <ListItem alignItems="center">
                    ...
                    <ListItemText primary="Malithi Perera" />
                    <ListItemSecondaryAction>
                ...
                <Grid container direction="column" className="list-container">
                    <Grid item xs={12}>
                        <Grid container>
                            <Grid item>
                                <Chip label="Long Term Leave" sx={chipWarningSX}  />
                            </Grid>
                        </Grid>
                    </Grid>
                    <Grid item xs={12} sx={{ pb: 2 }}>
                        <Typography variant="subtitle2" style={{paddingTop:"5px"}}>From 24/08/2022 to 28/08/2022</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid container>
                            <Grid item>
                            ...
                            <Grid item>
                                <Chip label="Process" sx={chipWarningSX} />
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
            ...
            <ListItemWrapper>
                ...
                <ListItem alignItems="center">
                    ...
                    <ListItemText primary="Bimsara Kulasekara" />
                    <ListItemSecondaryAction>
                        <Grid container justifyContent="flex-end">
                            <Grid item xs={12}>
                                {/* <Typography variant="caption" display="block" gutterBottom>
                ...
                <Grid container direction="column" className="list-container">
                    ...
                    <Grid item xs={12} sx={{ pb: 2 }}>
                        <Typography variant="subtitle2" style={{paddingTop:"5px"}}>From 24/08/2022 to 25/08/2022</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid container>
                            <Grid item>
                            ...
                            <Grid item>
                                <Chip label="Accept" sx={chipSuccessSX} />
                            </Grid>
                        </Grid>
                    </Grid>
                </Grid>
            ...
            <ListItemWrapper>
                ...
                <ListItem alignItems="center">
                    ...
                    <ListItemText primary="Pamodha Mahagamage" />
                    <ListItemSecondaryAction>
                        <Grid container justifyContent="flex-end">
                            <Grid item xs={12}>
                                {/* <Typography variant="caption" display="block" gutterBottom>
                ...
                <Grid container direction="column" className="list-container">
                    ...
                    <Grid item xs={12} sx={{ pb: 2 }}>
                        <Typography variant="subtitle2" style={{paddingTop:"5px"}}>For 24/08/2022</Typography>
                    </Grid>
                    <Grid item xs={12}>
                        <Grid container>
                            <Grid item>

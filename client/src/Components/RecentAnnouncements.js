    ...
    return (
        <>
            ...
            <Box style={{ display: 'flex', justifyContent: 'right' }}>
                <Button variant="contained" onClick={handleClickfullOpen} ><Typography className="seeall">All Annoucements</Typography></Button>
            </Box>
            ...
            <React.Fragment>
                ...
                >
                    <Formik
                        ...
                        validationSchema={Yup.object().shape({
                            ...
                            description: Yup.string().min(10, 'description is too short').max(255, 'description is too long').required('Description is required'),
                        })}
                        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {

                            axios
                            .post('http://localhost:5000/api/Annoucement/publishAnnoucment', {
                                title: values.title,
                ...
                <form noValidate onSubmit={handleSubmit} {...others}>
                    <DialogTitle sx={{backgroundColor: '#185A90',color:"white",fontSize:"16",textAlign:"center"}}>Annoucement Form</DialogTitle>
                    <DialogContent>
                    ...
                    >
                        ...
                        <FormControl sx={{ mt: 2, minWidth: 120 }} error={Boolean(touched.description && errors.description)}>
                        <TextareaAutosize
                            rows={5}

...
import PendingLeavescard from 'Components/LongtermLeavecard';
...
<<<<<<< HEAD:client/src/views/Admin/Leaves.js
...
>>>>>>> ba7068b973084811839542c6e429a372cbd31afc:client/src/views/Director/Leaves.js
    return (
        <><Box sx={{ flexGrow: 1 }}>
            <div className="main-leave-container">
                ...
                <div className="leavecontainer-right">
                    ...
                    <div className="onlineuser-container">
                        <Typography variant="h3" component="h4" textAlign={'center'}>
                            Pending Long Term Leave Requests
                        </Typography>
                        <Box style={{display:"flex", justifyContent: 'left', width:'100', top: "50%"}}>
                          <PendingLeavescard />        
                        </Box>
